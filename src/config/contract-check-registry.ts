...
export type ContractCheckRegistryEntry = {
  /** Порядковый номер в контрактном списке (1–45). */
  num: number;
...
export const CONTRACT_CHECK_REGISTRY: readonly ContractCheckRegistryEntry[] = [
  ...
  {
    num: 8,
    title: "Состав команды сверен с Discord и рабочей таблицей",
  ...
  { num: 16, title: "На проверке без движения >1 рабочего дня", ruleIds: ["review_stale"], scope: "task" },
